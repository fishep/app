...
public interface AuthFeign {
    ...
    Result<TokenCheckResponse> check(@RequestHeader("App-Guard") String guard, @RequestHeader("Authorization") String authorization, @RequestHeader("Accept-Language") String locale);
