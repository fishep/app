...
class AuthCaseServiceTest {
    ...
    void login() {
        ...
        assertThrows(ServiceException.class, () -> {authCaseService.adminLoginErp(new LoginDTO("root", "12345678888"));});

        assertNotNull(authCaseService.adminLoginErp(new LoginDTO("root@email.com", "12345678")));
        assertThrows(ServiceException.class, () -> {authCaseService.adminLoginErp(new LoginDTO("root@email.com", "12345678888"));});
        ...
        assertThrows(ServiceException.class, () -> {authCaseService.adminLoginErp(new LoginDTO("root", "4321"));});

        assertNotNull(authCaseService.adminLoginErp(new LoginDTO("root@email.com", "1234")));
        assertThrows(ServiceException.class, () -> {authCaseService.adminLoginErp(new LoginDTO("root@email.com", "4321"));});
